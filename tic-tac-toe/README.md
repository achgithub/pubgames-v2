# PubGames Tic Tac Toe

This is the standard template for creating new apps in the PubGames ecosystem.

## Architecture

- **Backend**: Go API (Port 30041)
- **Frontend**: React dev server (Port 30040)
...
- Frontend: http://localhost:30040
- Backend API: http://localhost:30041

## SSO Flow

1. User logs into Identity Service (http://localhost:3001)
2. Clicks app tile
3. Gets redirected to: `http://localhost:30040?token=JWT`
