    ...
    return (
      <div className="App">
        <div className="auth-container">
          {config.logo_url && (
            <img src={config.logo_url} alt="Logo" className="auth-logo" />
          )}
          ...
          {view === 'login' ? (
            <div className="auth-form">
              ...
              <p>
                ...
                <button onClick={() => setView('register')} className="link-btn">Register as Player</button>
                <button onClick={() => setView('register-admin')} className="link-btn">Register as Admin</button>
              </p>
            </div>
          ) : view === 'register' ? (
            <div className="auth-form">
